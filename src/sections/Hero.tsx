...
import memojiImage from "@/assets/images/dos-memoji.png";
  ...
  <div className ="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    ...
    <div className="container">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
        <a href="#projects">
          <button onClick={scrollToProjects} className="inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl">
